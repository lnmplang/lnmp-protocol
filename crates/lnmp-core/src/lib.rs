...
pub use container::{
    ...
    LNMP_FLAG_CHECKSUM_REQUIRED, LNMP_FLAG_COMPRESSED, LNMP_FLAG_ENCRYPTED, LNMP_FLAG_EXT_META_BLOCK,
    LNMP_FLAG_QKEX, LNMP_FLAG_QSIG, LNMP_HEADER_SIZE, LNMP_MAGIC,
};
