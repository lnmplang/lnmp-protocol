...
> **FID Registry:** All FID examples use official Field IDs from [`registry/fids.yaml`](../../../registry/fids.yaml).
...
// Nested values (v0.3) - F70=nested_data from registry
...
// Parse nested structures (F70=nested_data from registry)
