...
```rust
// v0.4: Text format only (F70=nested_data)
let text = "F70={F12=42;F20=test}";
...
record.add_field(LnmpField { fid: 12, value: LnmpValue::Int(42) });  // F12=user_id

// After: Nested records (F70=nested_data)
let mut inner = LnmpRecord::new();
inner.add_field(LnmpField { fid: 12, value: LnmpValue::Int(42) });  // F12=user_id
